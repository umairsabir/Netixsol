    ...
    <div className="w-full max-w-md">
      <div className="bg-white rounded-[3rem] p-10 shadow-2xl shadow-gray-200/50 border border-gray-50 relative overflow-hidden group">
          ...
          <div className="space-y-2">
            ...
            <div className="relative group">
              ...
              <input
                ...
                className="w-full bg-gray-50 border-2 border-transparent focus:border-black rounded-2xl pl-14 pr-14 py-4 font-bold outline-none transition-all placeholder:text-gray-300"
                placeholder="••••••••"
                required
              />
              <button
        ...
        <div className="mt-8 flex items-center gap-4">
          ...
          <p className="text-[10px] font-black uppercase tracking-widest text-gray-400">Or continue with</p>
          <div className="flex-1 h-px bg-gray-100"></div>
        </div>

        <div className="mt-6 flex gap-3">
          <button onClick={() => handleSocialLogin('google')} type="button" className="flex-1 h-12 bg-white border-2 border-gray-100 hover:border-black rounded-xl flex items-center justify-center transition-all hover:scale-[1.02] active:scale-[0.98]">
            {/* Google Icon (SVG) */}
          ...
          <button onClick={() => handleSocialLogin('github')} type="button" className="flex-1 h-12 bg-[#24292e] text-white rounded-xl flex items-center justify-center transition-all hover:scale-[1.02] active:scale-[0.98]">
            {/* GitHub Icon (SVG) */}
          ...
          <button onClick={() => handleSocialLogin('discord')} type="button" className="flex-1 h-12 bg-[#5865F2] text-white rounded-xl flex items-center justify-center transition-all hover:scale-[1.02] active:scale-[0.98]">
            {/* Discord Icon (SVG) */}
            <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
