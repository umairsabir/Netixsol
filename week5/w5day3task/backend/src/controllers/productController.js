...
exports.updateProduct = async (req, res) => {
    try {
        ...
        // Trigger NestJS Webhook for real-time notification on price/stock updates
        if (req.body.price !== undefined || req.body.variants !== undefined) {
            const axios = require('axios');
            axios.post('http://localhost:3000/api/notifications/webhook/product-update', {
                ...
                console.error('Failed to trigger NestJS product update webhook:', err.message);
            });
        }
